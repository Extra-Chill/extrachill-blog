...
### Added
- give the Power page network cards stable analytics CTA ids
...
### Added
- expose public festival projections

### Changed
- retire artist and festival follow surfaces
- consume owner activity projections

### Fixed
- clear remaining release lint
- restore release lint for entity projections

## [0.15.3] - 2026-08-04

### Changed
- remove artist email-sharing controls

## [0.15.2] - 2026-07-30

### Fixed
- guard artist login redirect
- collapse artist preferences into one notice

## [0.15.1] - 2026-07-29

### Fixed
- satisfy typed receipt contracts
- make entity notification delivery retry-safe

## [0.15.0] - 2026-07-29

### Added
- add artist preference controls

## [0.14.5] - 2026-07-26

### Fixed
- simplify Recently Shipped release rows

## [0.14.4] - 2026-07-26

### Fixed
- remove Recently Shipped category labels

## [0.14.3] - 2026-07-18

### Fixed
- make Artist Dispatch copy artist-friendly

## [0.14.2] - 2026-07-18

### Changed
- adopt versioned geographic holdout lifecycle

### Fixed
- align Artist Dispatch with design system

## [0.14.1] - 2026-07-18

### Changed
- limit Artist Dispatch review queue

## [0.14.0] - 2026-07-18

### Added
- run geographic bridge holdout
- launch Artist Dispatch submissions
- bridge geographic stories to network destinations
...
### Added
- make the homepage a personalized network hub
- add artist event relationship badges

## [0.12.1] - 2026-07-13

### Fixed
- improve artist activity context

## [0.12.0] - 2026-07-13

### Added
- add artist activity timeline

## [0.11.0] - 2026-07-13

### Added
- add artist editorial routers

## [0.10.1] - 2026-07-12

### Fixed
- encode subscription status input (#49)

## [0.10.0] - 2026-07-12

### Added
- add festival subscription updates
- surface festival discussions on pillars (#44)
- compose festival archive pillars (#41)

### Changed
- consume canonical Local Scene

## [0.9.0] - 2026-07-12

### Added
- prioritize users default event market

### Fixed
- restore balanced homepage network grid

## [0.8.0] - 2026-07-12

### Added
- Recently Shipped homepage strip
- restructure homepage as live network dashboard
...
### Changed
- own login/register CTA placement via theme hook
- consume shared network bridge primitive from multisite

## [0.7.1] - 2026-06-20

### Fixed
- differentiate /power hero from homepage + fix stale Austin location

## [0.7.0] - 2026-06-20

### Added
- add open-source/engineering door to /power network map + fix broken vision CTA

## [0.6.8] - 2026-06-20

### Fixed
- reframe /power calendar copy around its real mission

## [0.6.7] - 2026-06-20

### Fixed
- remove false 'independent / not ad buys' claims from /power calendar copy

## [0.6.6] - 2026-06-20

### Fixed
- de-dupe /power pillar titles

## [0.6.5] - 2026-06-20

### Fixed
- center /power section headings + sharpen pillar copy

## [0.6.4] - 2026-06-20

### Fixed
- make /power pillar titles h3 so they don't inherit the section-heading underline

## [0.6.3] - 2026-06-20

### Fixed
- remove inherited accent h2 underline from /power headings

## [0.6.2] - 2026-06-20

### Fixed
- render /power server-side with live design tokens for dark-mode support

## [0.6.1] - 2026-06-20

### Fixed
- correct /power artist benefits — drop per-artist forum and rollout-gated merch claims

## [0.6.0] - 2026-06-19

### Added
- add /power network manifesto landing page composed from pillar pattern + live NetworkStats

## [0.5.1] - 2026-06-15

### Fixed
- stop synthesizing crawlable community search URLs in single-post bridge

## [0.5.0] - 2026-06-13

### Added
- feat(network-bridge): surface artist profile and shop cards on single posts
